...
const ALL_AUTHOR = ['rapeeee', 'thitiluang', 'klaikong', 'bact', 'theerapol',
                    'kyoreadingroom', 'pexcoplanet', 'nakwan', 'fon', 'tavirot',
                    'yanyong', 'shinshinshin'];
const ALL_TAG = ['สายไฟ', 'ทางเดินเท้า', 'เกะกะ', 'BTS', 'แผงลอย', 'เดินไม่ได้',
                'ขยะเหม็นมาก', 'มืดมากกก', 'หลุม', 'ตู่โทรศัพท์', 'เสียงดัง'];
const ALL_ISSUE = [
  'สายไฟห้อยลงมาเกี่ยวกับลิฟท์',
